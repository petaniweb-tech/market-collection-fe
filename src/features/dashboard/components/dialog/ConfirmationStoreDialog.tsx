...
interface ConfirmationStoreDialogProps {
  open: boolean;
...
const ConfirmationStoreDialog = ({
  ...
  const defaultDescription = isDeactivate
    ? "Apakah anda yakin ingin menonaktifkan lapak ini dari sistem?"
    : "Apakah anda yakin ingin mengaktifkan kembali lapak ini dari sistem?";
...
export default ConfirmationStoreDialog;
